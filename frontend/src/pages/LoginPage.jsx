                    ...
                    <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl border-4 border-black p-10">
                        ...
                        <div className="space-y-4 mb-6">
                            <button
                                ...
                                className="w-full bg-white text-black border-2 border-gray-200 py-3 rounded-xl font-bold flex items-center justify-center gap-3 hover:border-black hover:bg-gray-50 transition-all"
                            >
